...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "0GNMSJJcHzx8Yevo3OZzt8MSh", consumerSecret: "UWhzy9gwvz32DlUXwukGXCgQvn8XX9HYyoppHLD7gzKxWRkZI2")
    var loginSuccess: (() -> ())?
